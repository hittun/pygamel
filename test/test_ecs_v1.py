...
def run():
    ...
    world.add_component(player, Renderable(image=pygame.image.load(assetpath.get_asset_char("redsquare.png")), posx=100, posy=100))
    # Another motionless Entity:
    enemy = world.create_entity()
    world.add_component(enemy, Renderable(image=pygame.image.load(assetpath.get_asset_char("bluesquare.png")), posx=400, posy=250))
